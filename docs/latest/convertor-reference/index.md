...
- [Chef]({% link latest/convertor-reference/chef.md %}): Cookbook analysis and migration
- [PowerShell]({% link latest/convertor-reference/powershell.md %}): Script and DSC configuration migration
- [Ansible]({% link latest/convertor-reference/ansible.md %}): Legacy role modernization
- [Puppet]({% link latest/convertor-reference/puppet.md %}): Manifest analysis and migration
