...
[Detailed Init documentation]({% link latest/phases/init.md %})
...
[Detailed Analyze documentation]({% link latest/phases/analyze.md %})
...
[Detailed Migrate documentation]({% link latest/phases/migrate.md %})
...
[Detailed Publish documentation]({% link latest/phases/publish.md %})
