...
- [CLI Reference]({% link v0.5/convertor-reference/cli-reference.md %}): Complete command documentation
- [Configuration]({% link v0.5/convertor-reference/configuration_options.md %}): Environment variables and LLM provider setup
- [Usage Examples]({% link v0.5/convertor-reference/usage.md %}): Detailed CLI and Docker usage examples

## Source Technologies

- [Chef]({% link v0.5/convertor-reference/chef.md %}): Cookbook analysis and migration
- [PowerShell]({% link v0.5/convertor-reference/powershell.md %}): Script and DSC configuration migration
- [Ansible]({% link v0.5/convertor-reference/ansible.md %}): Legacy role modernization
- [Puppet]({% link v0.5/convertor-reference/puppet.md %}): Manifest analysis and migration
