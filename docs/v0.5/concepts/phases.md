...
[Detailed Init documentation]({% link v0.5/phases/init.md %})
...
[Detailed Analyze documentation]({% link v0.5/phases/analyze.md %})
...
[Detailed Migrate documentation]({% link v0.5/phases/migrate.md %})
...
[Detailed Publish documentation]({% link v0.5/phases/publish.md %})
