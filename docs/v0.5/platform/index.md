...
### [Installation]({% link v0.5/platform/installation.md %})
Deployment guide for OpenShift and Kubernetes environments.

### [Installation (vanilla Backstage)]({% link v0.5/platform/installation-backstage.md %})
Add published `@red-hat-developer-hub/*` X2A packages to a freshly generated `create-app` Backstage instance.

### [Authentication]({% link v0.5/platform/authentication.md %})
OAuth setup, providers, and user management.

### [Authorization]({% link v0.5/platform/authorization.md %})
RBAC permissions and access control policies.

### [MCP tools]({% link v0.5/platform/mcp-server.md %})
Connect assistants to Conversion Hub via RBAC-aware MCP tools.

### [CSV Bulk Import]({% link v0.5/platform/csv-bulk-import.md %})
Create multiple conversion projects at once by uploading a CSV file.

### [API Reference]({% link v0.5/platform/api-reference.md %})
Swagger UI for exploring the OpenAPI specification.

### [Plugin Compatibility]({% link v0.5/platform/plugin-compatibility.md %})
