...
Adversarial agents can also be created and managed programmatically. See the [API Reference]({% link v0.5/platform/api-reference.md %}) for the `adversarial-agents` endpoints.
